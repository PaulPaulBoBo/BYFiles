...
@property (nonatomic, copy) GBTaskReportBlock reportBlock;
@property (nonatomic, readwrite, strong) NSString *lastCommandLine;
@property (nonatomic, readwrite, strong) NSString *lastStandardOutput;
@property (nonatomic, readwrite, strong) NSString *lastStandardError;
