...
typedef void(^FindCompletion)(NSArray *paths);

@interface FindConnectClasses : BaseComment

@property (nonatomic, strong) FindCompletion findCompletion;
